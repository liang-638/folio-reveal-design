...
import { User, Image, User as CharacterIcon, Layers, ChevronRight, Info } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, onSectionChange }) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-card/50 backdrop-blur-sm border-r border-border z-40">
      <div className="p-6">
